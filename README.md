...
> Your GitHub profile, always in your pocket.

Shikai is a mobile-first GitHub dashboard designed for developers who want to stay connected with their work without the noise. It's a read-only companion app that gives you a beautiful, distraction-free view of your repositories, contributions, and activity-all from your phone.
...
- See your contribution graph at a glance
- Browse your pinned repositories
- Catch up on recent activity across all your repos
...
- Read READMEs rendered beautifully in your app
- Explore the full file tree without leaving the app
- Browse commit history with clean, readable formatting

### **Starred Repos**

- Keep tabs on projects you've starred
- Quick access to repos you care about

### **Profile**

- Your GitHub profile card, always ready to share
- Stats at a glance: repos, followers, stars, contributions
...
- **Students and learners** who want to track their coding progress on the go
- **Open source contributors** who want to monitor their repos and stars
- **Anyone who's proud of their GitHub streak** and wants to see it throughout the day
...
Shikai uses a GitHub Personal Access Token (PAT) to securely access your data. You generate the token once, and the app stores it securely on your device. No servers, no third-party data storage-just you and GitHub's API.
...
🚧 **In Development** - Shikai is being actively built. Features are rolling out, and the first release is coming soon.
